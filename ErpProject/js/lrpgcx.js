        		...
        		{ header: '物料编号', dataIndex: 'name', width: 100, },
       			 {
       				 ...
       				 { header: '（本币金额）', dataIndex: 'bianma' },
       				 { header: '（实际成本）', dataIndex: 'bianma' },
       				 { header: '（实际毛利）', dataIndex: 'bianma' },
       				 { header: '（实际毛利率(%）', dataIndex: 'bianma' },
       				 { header: '（标准成本）', dataIndex: 'bianma' },
       				 { header: '（标准毛利）', dataIndex: 'bianma' },
       				 { header: '（标准毛利率(%)）', dataIndex: 'bianma' }
    ],
