...
var yfgrids = Ext.create('Ext.grid.Panel', {
    ...
    columns: [
        		...
        		{ header: '来源别', dataIndex: 'name', width: 155, },
       			 {
       			     header: '来源日期', dataIndex: 'dizhi', width: 155, editor: {
       			         xtype: 'textfield',
       			         listeners: {
       			             focus: function (grid, e, eOpts) {
       			                 windows2.show();
					 ...
					 { header: '预付金额', dataIndex: 'lianxi', width: 200, },
					 { header: '部门编号', dataIndex: 'lianxi', width: 200, },
					 { header: '部门名称', dataIndex: 'lianxi', width: 200, },
					 { header: '取用预付金额', dataIndex: 'lianxi', width: 200, },
					 { header: '来源摘要', dataIndex: 'lianxi', width: 400, }
...
var yf = Ext.create('Ext.panel.Panel', {
    bodyPadding: 6,  // 避免Panel中的子元素紧邻边框
    width: 1600,
    height: 170,
    items: [yfgrids],
...
var tableds = Ext.create('Ext.TabPanel', {
    ...
    autoScroll: true,
    bodyPadding: 5,
    items: [{ title: '内容', autoScroll: true, items: [filterPanel] }, { title: '取用预付', autoScroll: true, items: [yf] }, { title: '备注', xtype: 'textarea', name: 'Remark', fieldLabel: '备注', labelWidth: 30, }],
});
