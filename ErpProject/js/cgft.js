...
var grids = Ext.create('Ext.grid.Panel', {
    ...
    columns: [
        		...
        		{ header: '费用编号', dataIndex: 'name', width: 100, style: 'color:blue' },
       			 {
       			     header: '（费用名称）', dataIndex: 'dizhi', width: 120, editor: {
       			         xtype: 'textfield',
       			         listeners: {
       				 ...
       				 { header: '币别', dataIndex: 'bianma', style: 'color:blue' },
					 { header: '汇率', dataIndex: 'lianxi' },
					 { header: '金额', dataIndex: 'lianxi' },
					 { header: '（金额本位币）', dataIndex: 'lianxi' },
    ],
    height: 130,
    width: 1000,
    autoScroll: false,
...
var grids1 = Ext.create('Ext.grid.Panel', {
    ...
    columns: [
        		...
        		{ header: '采购入库单', dataIndex: 'name', width: 100, style: 'color:blue' },
       			 {
       			     header: '物料编号', dataIndex: 'dizhi', width: 120, style: 'color:blue', editor: {
       			         xtype: 'textfield',
       			         listeners: {
       			             focus: function (grid, e, eOpts) {
       			                 windows2.show();
					 ...
					 { header: '（采购金额）', dataIndex: 'lianxi' },
					 { header: '（数量）', dataIndex: 'lianxi' },
					 { header: '（单位）', dataIndex: 'lianxi' },
					 { header: '（重量）', dataIndex: 'lianxi' },
					 { header: '（材积）', dataIndex: 'lianxi' },
					 { header: '(分摊金额)', dataIndex: 'lianxi' },
    ],
    height: 130,
    width: 1000,
    autoScroll: false,
...
var tableds = Ext.create('Ext.TabPanel', {
    ...
    autoScroll: true,
    bodyPadding: 5,
    items: [{ title: '费用明细', autoScroll: true, items: [filterPanel] }, { title: '分摊结果', autoScroll: true, items: [filterPanel1] }],
});
