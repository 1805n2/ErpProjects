...
var grids = Ext.create('Ext.grid.Panel', {
    ...
    columns: [
        		...
        		{ header: '物料编号', dataIndex: 'name', width: 100, style: 'color:blue' },
       			 {
					 ...
					 { header: '（库存量）', dataIndex: 'lianxi' },
					 { header: '（平均成本）', dataIndex: 'lianxi' },
					 { header: '（单价）', dataIndex: 'lianxi' },
					 { header: '（调价金额）', dataIndex: 'lianxi' },
    ...
    items: [{ title: '内容', autoScroll: true, items: [filterPanel] },
	{
	    ...
	    baseCls: 'x-plain', items: [{
	        ...
	        selectOnFocus: true,
                    ...
                    { style: 'margin-left:20px', xtype: 'textarea', width: 500, height: 150, name: 'Remark', fieldLabel: '备注', labelWidth: 30, }]
	}],
});
